namespace CreateFrame.AddInWorkers
{
    partial class Form_EnterSize
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "Введите габраритные размеры рамы";
            // 
            // label2
            // 
            ...
            label3.Font = new Font("Segoe UI Light", 12F, FontStyle.Regular, GraphicsUnit.Point, 204);
            label3.Location = new Point(54, 134);
            label3.Name = "label3";
            label3.Size = new Size(100, 21);
            label3.TabIndex = 2;
            label3.Text = "Ширина, мм:";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.BackColor = SystemColors.Control;
            label4.Font = new Font("Segoe UI Light", 12F, FontStyle.Regular, GraphicsUnit.Point, 204);
            label4.Location = new Point(62, 181);
            label4.Name = "label4";
            label4.Size = new Size(92, 21);
            label4.TabIndex = 3;
            label4.Text = "Высота, мм:";
            // 
            // textBox1
            // 
            ...
            textBox2.Location = new Point(160, 134);
            ...
            textBox3.Location = new Point(160, 181);
            textBox3.Name = "textBox3";
            textBox3.Size = new Size(207, 29);
            textBox3.TabIndex = 6;
            // 
            // button1
            // 
            ...
            button1.TabIndex = 7;
            button1.Text = "Сформировать раму";
